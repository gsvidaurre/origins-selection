...
- Get and plot coverage
- Update population map
- Start re-running populations across optimization parameters
- Visualize kmer_filter and clone_filter output
